...
# countries. Technicaly the global data contains all the information present in each individual country. This will demonstrate if
...
# #### The submission file for the compettition was generated by this model.
...
# In this chapter the LSTM trained on the global data is tested on data from individual countries. This will determine how well
...
# The GRU is a simplified and modern version of the LSTM. Because the code in this chapter is essencialy the same as the LSTM,
