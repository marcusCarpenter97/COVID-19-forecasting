...
def RNNMultiOutput(temporal_input_shape, recurrent_units, output_size, name, layer, activation):
    """
    Individual weights.
    """
    temporal_inputs = keras.Input(shape=temporal_input_shape, name="time_series_input")
    word_inputs = keras.Input(shape=1, name="country_name_input")
...
def RNNMultiOutput_V2(temporal_input_shape, recurrent_units, output_size, name, layer, activation):
    """
    Shared weights.
    """
    temporal_inputs = keras.Input(shape=temporal_input_shape, name="time_series_input")
...
def RNNSingleOutput(temporal_input_shape, recurrent_units, output_size, name, layer, activation):
    temporal_inputs = keras.Input(shape=temporal_input_shape, name="time_series_input")
    word_inputs = keras.Input(shape=1, name="country_name_input")
...
def RNNSingleOutputQuantile(temporal_input_shape, recurrent_units, output_size, name, layer, activation):
    """
...
def RNNMultiOutputQuantile(temporal_input_shape, recurrent_units, output_size, name, layer, activation):
    """
...
def LSTMMultiOutput(temporal_input_shape, recurrent_units, output_size, activation='relu'):
    name = "LSTM"
    layer = layers.LSTM
    return RNNMultiOutput(temporal_input_shape, recurrent_units, output_size, name, layer, activation)

def LSTMSingleOutput(temporal_input_shape, recurrent_units, output_size, activation='relu'):
    name = "LSTM"
    layer = layers.LSTM
    return RNNSingleOutput(temporal_input_shape, recurrent_units, output_size, name, layer, activation)

def LSTMMultiOutput_V2(temporal_input_shape, recurrent_units, output_size, activation='relu'):
    name = "LSTM"
    layer = layers.LSTM
    return RNNMultiOutput_V2(temporal_input_shape, recurrent_units, output_size, name, layer, activation)

def LSTMMultiOutputQuantile(temporal_input_shape, recurrent_units, output_size, activation='relu'):
    name = "LSTM"
    layer = layers.LSTM
    return RNNMultiOutputQuantile(temporal_input_shape, recurrent_units, output_size, name, layer, activation)

def LSTMSingleOutputQuantile(temporal_input_shape, recurrent_units, output_size, activation='relu'):
    name = "LSTM"
    layer = layers.LSTM
    return RNNSingleOutputQuantile(temporal_input_shape, recurrent_units, output_size, name, layer, activation)

def GRUMultiOutput(temporal_input_shape, recurrent_units, output_size, activation='relu'):
    name = "GRU"
    layer = layers.GRU
    return RNNMultiOutput(temporal_input_shape, recurrent_units, output_size, name, layer, activation)

def GRUSingleOutput(temporal_input_shape, recurrent_units, output_size, activation='relu'):
    name = "GRU"
    layer = layers.GRU
    return RNNSingleOutput(temporal_input_shape, recurrent_units, output_size, name, layer, activation)

def GRUMultiOutput_V2(temporal_input_shape, recurrent_units, output_size, activation='relu'):
    name = "GRU"
    layer = layers.GRU
    return RNNMultiOutput_V2(temporal_input_shape, recurrent_units, output_size, name, layer, activation)

def GRUMultiOutputQuantile(temporal_input_shape, recurrent_units, output_size, activation='relu'):
    name = "GRU"
    layer = layers.GRU
    return RNNMultiOutputQuantile(temporal_input_shape, recurrent_units, output_size, name, layer, activation)

def GRUSingleOutputQuantile(temporal_input_shape, recurrent_units, output_size, activation='relu'):
    name = "GRU"
    layer = layers.GRU
    return RNNSingleOutputQuantile(temporal_input_shape, recurrent_units, output_size, name, layer, activation)
